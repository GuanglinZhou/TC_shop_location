...
public class UDFTest {
  ...
  public void simpleInput() throws Exception{
    BaseRunner runner = new UDFRunner(null, "com.aliyun.odps.examples.udf.MyUDFExample");
  ...
  public void inputFromTable() throws Exception{
    BaseRunner runner = new UDFRunner(TestUtil.getOdps(), "com.aliyun.odps.examples.udf.MyUDFExample");
